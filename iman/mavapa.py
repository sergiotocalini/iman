...
# MAVAPA_SERVER = current_app.config['MAVAPA_URL']
# MAVAPA_SERVER = 'https://accounts.corpam.com.ar/'
# AUTH_URL = MAVAPA_SERVER + '/auth?response_type=code'
# TOKEN_URL = MAVAPA_SERVER + '/token'
# USER_INFO_URL = MAVAPA_SERVER + '/who_im/'
# LOGOUT_URL = MAVAPA_SERVER + '/logout'
